 ...
 *
 * Defines the Progressive Web App (PWA) manifest for Legal Docs Scanner, enabling
...
export default function manifest(): MetadataRoute.Manifest {
  return {
    // App Identity
    name: "Legal Docs Scanner - AI Legal Information Extraction",
    short_name: "Legal Docs Scanner",
    description:
      "Extract key information from legal documents with NLP and machine learning",
