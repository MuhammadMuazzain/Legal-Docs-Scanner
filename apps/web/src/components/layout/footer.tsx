...
export function Footer() {
  ...
  const socialLinks = [
    {
      href: "https://github.com/MuhammadMuazzain/Legal-Docs-Scanner",
      icon: Github,
      label: "GitHub",
    },
    {
      href: "https://linkedin.com/in/muhammadmuazzain",
      icon: Linkedin,
      label: "LinkedIn",
    },
  ];
      ...
      <div className="container grid gap-8 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground">
            NLP and machine learning for extracting key information from legal
            documents — built for accuracy, legal terminology, and compliance.
          </p>
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <a
                ...
                aria-label="Send email to muhammadmuazzain07@gmail.com"
              >
      ...
      <div className="container mt-12 border-t pt-6">
        <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
          ...
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} Muhammad Muazzain. All rights reserved.
          </p>
