...
/**
 * Hero section component for the Legal Docs Scanner homepage
 *
        ...
        <div className="mx-auto max-w-3xl text-center">
          <div className="mb-6 flex items-center justify-center gap-2">
            <div className="rounded-full bg-primary/10 px-3 py-1 text-sm font-medium text-primary">
              NLP · Machine Learning · Legal Extraction
            </div>
          </div>
          ...
          <p className="mb-10 text-xl text-muted-foreground">
            Design and run AI models that understand legal terminology, pull out
            critical clauses and entities, and keep extraction accurate and
            compliance-ready.
          </p>
            ...
            {[
              {
                ...
                description:
                  "Structured outputs for parties, dates, obligations, and key clauses",
              },
              {
                icon: <Scale className="h-6 w-6 text-primary" />,
                title: "Legal Terminology",
                description:
                  "Models tuned on legal language and domain-specific clause types",
              },
              {
                icon: <GraduationCap className="h-6 w-6 text-primary" />,
                title: "Compliance-Aware",
                description:
                  "Human-in-the-loop review paths to validate and refine results",
              },
            ].map((item, index) => (
