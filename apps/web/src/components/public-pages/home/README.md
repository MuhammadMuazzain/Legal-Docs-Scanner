...
This directory contains all the components used to build the public-facing homepage of the Legal Docs Scanner application. These components work together to create a compelling landing page experience that showcases the AI-powered legal document analysis platform.
