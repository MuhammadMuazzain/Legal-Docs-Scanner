/**
 * @fileoverview Public home page components for Legal Docs Scanner landing page
 *
 * This barrel file exports all the main components used in the public-facing
 * homepage of the Legal Docs Scanner application. These components work together to
