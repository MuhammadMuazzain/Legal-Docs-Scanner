...
This directory contains all shared/reusable components used throughout the Legal Docs Scanner application. These components provide common functionality, maintain design consistency, and improve development efficiency.
