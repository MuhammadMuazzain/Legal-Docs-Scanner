# Legal Docs Scanner Library Utilities

This directory contains shared utility functions, chart helpers, and document utilities used throughout the Legal Docs Scanner application. Each utility is designed to be reusable, well-documented, and follows best practices.
