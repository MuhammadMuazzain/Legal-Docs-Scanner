...
This directory contains custom React hooks used throughout the Legal Docs Scanner application. Each hook is designed to be reusable, well-documented, and follows React best practices.
